	...
	const f = function() {},
		...
		nanoCopy = (data,options={},cloned=new WeakMap()) => {
			const type = typeof(data),
				{nonStandard,nonEnumerable} = options; // nonEnumerable not yet supported
			...
			if(cloners.has(data.constructor)) {
				...
				clone = Array.isArray(data) ? new data.constructor() : Object.create(Object.getPrototypeOf(data));
				cloned.set(data,clone);
				for(const key in data) {
